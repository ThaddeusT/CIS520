...
thread_init (void) 
{
  ...
  /* Set up a thread strucfture for the running thread. */
               ...
               thread_func *function, void *aux) 
{
  ...
  ASSERT(priority >= PRI_MIN && priority <= PRI_MAX); // new
...
thread_yield (void)  
{
  ...
  if (cur != idle_thread) 
	...
	list_insert_ordered (&ready_list, &cur -> elem, thread_lower_priority, NULL); //new
...
thread_set_priority (int new_priority) 
{
  ...
  thread_priority_donation(thread_current(), new_priority, true);   //new
}
